    ...
    <script>
        ...
        async function codeScanned() {
            ...
            if(currentCode == code) {
                ...
                window.location.href = "<?= base_url("schuelerdaten-anzeigen/") ?>/" + code;
            }
        }

        <?php 
            if(esc($schuelerId) != false)
            {
                if(esc($error == ""))
                {
                    echo("success()");
        ...
        async function success()
        {
            ...
            window.location.href = "<?= base_url("show-schueler/" . esc($schuelerId)) ?>/" + code;
        }
        ...
        async function fail()
        {
            ...
            notFoundDiv.innerHTML = "<p><?= esc($error) ?> <br> <a href='<?= base_url("schuelerdaten-anzeigen/") ?>'>erneut scannen</a> </p> <img src='<?= base_url("public/imgs/warning_white.png") ?>'/>";
