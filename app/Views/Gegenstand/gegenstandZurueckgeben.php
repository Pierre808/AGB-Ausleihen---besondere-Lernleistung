    ...
    <script>
        ...
        async function codeScanned() {
            ...
            if(currentCode == code) {
                ...
                window.location.href = "<?= base_url("gegenstand-zurueckgeben/") ?>/" + code;
            }
        }
        ...
        async function fail()
        {
            ...
            notFoundDiv.innerHTML = "<p><?= esc($error) ?> <br> <a href='<?= base_url("gegenstand-zurueckgeben") ?>'>erneut scannen</a> </p> <img src='<?= base_url("public/imgs/warning_white.png") ?>'/>";
